...
import 'cipher_tools_dialog.dart';
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _LiquidGlassToolCard(
                  title: 'AMPC\\x01 ➔ Repair',
                  subtitle: 'Self-Healing Auto-Repair',
                  icon: Icons.healing_rounded,
                  onTap: () {
                    if (repository != null) {
                      CipherToolsDialog.showVaultSelfHealingRepairDialog(context, repository);
                    } else {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          backgroundColor: Colors.amber[800],
                          content: Text('Please unlock the vault first to initiate deep recovery.', style: GoogleFonts.outfit()),
                        ),
                      );
                    }
                  },
