...
class _VaultPageState extends State<VaultPage>
  ...
  void _showSecurityRecoveryDialog(BuildContext context) {
    ...
    showDialog(
      context: context,
      builder: (dialogContext) => BackupRestoreDialog(
        vaultPath: vaultPath,
        onRecoverSLIP39: (phrases) {
          context.read<VaultBloc>().add(RecoverVaultEvent(phrases));
        },
        onRestoreBackupFile: (restoredPath) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              backgroundColor: kSuccessColor,
              content: Text(
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          CryptomatorBanners(
            onUpdateTap: () => _showPreferencesDialog(context, initialTab: 4),
            onSupportTap: () => _showPreferencesDialog(context, initialTab: 5),
          ),
          Expanded(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Switch(
            value: value,
            activeThumbColor: kPrimaryHoverColor,
            onChanged: onChanged,
          ),
        ],
      ),
...
class _UnlockedDashboardViewState extends State<UnlockedDashboardView> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            kSuccessColor.withValues(alpha: 0.06),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.key, color: kPrimaryColor, size: 14),
                          const SizedBox(width: 8),
                          Expanded(
                            child: SingleChildScrollView(
  ...
  Widget _statusItem({
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(8),
      decoration: BoxDecoration(
        color: const Color(0xFF1E1E38).withValues(alpha: 0.3),
        border: Border.all(color: const Color(0xFF1E293B)),
        borderRadius: BorderRadius.circular(8),
      ),
      child: Column(
...
InputDecoration _inputDecoration({
  ...
  return InputDecoration(
    ...
    suffixIcon: suffix,
    filled: true,
    fillColor: const Color(0xFF0A0E17).withValues(alpha: 0.6),
