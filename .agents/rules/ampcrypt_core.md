...
4-Factor Authentication (4FA): The 4 shares are unlocked exclusively via 4 separate local factors:
...
Emergency Recovery: SLIP39 (24-word Master Recovery Phrase) is generated offline for fallback.

Zero-Cost Infrastructure: Absolutely NO paid cloud services. Use GitHub Pages for Web hosting and Firebase Spark Plan (Free Tier) strictly for metadata/Trusted Device hashes.

Behavioral Heuristics: Implement background Directory.watch and Isolation Forest Anomaly Detection to block unauthorized file edits, moves, or deletes (Ransomware protection).
